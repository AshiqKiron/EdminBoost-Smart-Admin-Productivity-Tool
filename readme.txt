=== Edmin - Boost Smart Admin Productivity Tool ===
...
Edmin Boost is a smart admin productivity plugin for WordPress. It helps site administrators customize and optimize the WordPress admin experience with modular, opt-in tools.

= Features =

* **Hide Admin Notices** — Reduce clutter by hiding notices outside Edmin Boost screens
...
3. Go to **Edmin Boost** in the admin sidebar to get started.
...
Edmin Boost provides modular admin productivity tools. Each feature can be enabled or disabled independently from the Settings page.

= Who can access the plugin settings? =

Only users with the `manage_options` capability (typically Administrators) can access Edmin Boost settings.

= Does this plugin send data to external servers? =

No. Edmin Boost does not track users or send site data to external servers.
...
* Harden settings sanitization and menu protection for Edmin Boost screens.
